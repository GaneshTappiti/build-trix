                ...
                <Button asChild className="h-auto flex-col gap-2 p-6">
                  <Link href="/mvp-generator">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs opacity-90">Generate your next big thing</div>
                    </div>
                  </Link>
                </Button>
...
function getNextStepSuggestion(stats: ReturnType<typeof calculateStats>) {
    ...
    return (
      <>
        ...
        <Button asChild size="sm" className="w-full">
          <Link href="/mvp-generator">Generate Your First MVP</Link>
        </Button>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <Button asChild size="sm" className="w-full">
        <Link href="/mvp-generator">Create Another MVP</Link>
      </Button>
    </>
  );
}
